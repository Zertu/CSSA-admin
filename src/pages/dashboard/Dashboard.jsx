            ...
            <Table responsive borderless className={cx("mb-0", s.usersTable)}>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>bob@email.com</td>
                  <td>
                    <span className="py-0 px-1 bg-warning rounded text-white">
                      delayed
                    </span>
                  </td>
                </tr>
        ...
        <Col sm={12} md={6}>
          <Widget title="Alerts">
            <Alert className="alert-sm" color="warning">
              <span className="fw-semi-bold">Warning:</span> Best check yo self,
            ...
            <Alert className="alert-sm" color="info">
              <span className="fw-semi-bold">Info:</span> This alert needs your
              attention, but it&#39;s not super important.
            </Alert>
            <Alert className="alert-sm clearfix" color="danger">
              <span className="fw-semi-bold">Danger:</span> Change this and that
              and try again.
        ...
        <Col sm={6}>
          <Widget
            title={
              <div>
                <div className="pull-right mt-n-xs">
                  <Link to="/app/main" className="td-underline fs-sm">
                    Options
                  </Link>
                </div>
              ...
              <tbody>
                {posts &&
                  posts.map((post) => (
                    <tr key={post.id}>
                      <td>
                        {formatDate(new Date(post.updatedAt).toLocaleString())}
                      </td>
                      <td>
