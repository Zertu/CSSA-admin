...
const addNew = () => {
  ...
  return (
    <div>
      ...
      <Row>
        <Col sm={11}>    <h1 className="mb-lg">Articles</h1></Col>
        <Col sm={1} align-self='left'>    
            <div style={{display:"flex",justifyContent:"flex-end"}}>  <Button onClick={addNew} size="sm" color="success" className="mr-sm mb-xs">
                + New
              </Button></div>
